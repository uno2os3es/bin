...
def main():
    ...
    parser.add_argument("-r", "--recursive", action="store_true", help="Recursively clean all .py files in current dir")
    parser.add_argument("--inplace", action="store_true", help="Update files in place")
